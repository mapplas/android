...
public class CommentAdapter extends ArrayAdapter<Comment> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(o != null) {
			...
			tt.setTypeface(((MapplasApplication)getContext().getApplicationContext()).getTypeFace());
			...
			/*
			 * float r = o.getRate(); ImageView img1 = (ImageView)
			 * v.findViewById(R.id.imgStar1); ImageView img2 = (ImageView)
			 * v.findViewById(R.id.imgStar2); ImageView img3 = (ImageView)
			 * v.findViewById(R.id.imgStar3); ImageView img4 = (ImageView)
			 * v.findViewById(R.id.imgStar4); ImageView img5 = (ImageView)
			 * v.findViewById(R.id.imgStar5); if(r >= 0.5f) {
			 ...
			 * img5.setBackgroundResource(R.drawable.icon_not_important); } if(r
			 * >= 1.0f) { img1.setBackgroundResource(R.drawable.icon_important);
			 * img2.setBackgroundResource(R.drawable.icon_not_important);
			 * img3.setBackgroundResource(R.drawable.icon_not_important);
			 * img4.setBackgroundResource(R.drawable.icon_not_important);
			 * img5.setBackgroundResource(R.drawable.icon_not_important); } if(r
			 * >= 1.5f) { img1.setBackgroundResource(R.drawable.icon_important);
			 * img2.setBackgroundResource(R.drawable.icon_half_important);
			 * img3.setBackgroundResource(R.drawable.icon_not_important);
			 * img4.setBackgroundResource(R.drawable.icon_not_important);
			 * img5.setBackgroundResource(R.drawable.icon_not_important); } if(r
			 * >= 2.0f) { img1.setBackgroundResource(R.drawable.icon_important);
			 * img2.setBackgroundResource(R.drawable.icon_important);
			 * img3.setBackgroundResource(R.drawable.icon_not_important);
			 * img4.setBackgroundResource(R.drawable.icon_not_important);
			 * img5.setBackgroundResource(R.drawable.icon_not_important); } if(r
			 * >= 2.5f) { img1.setBackgroundResource(R.drawable.icon_important);
			 * img2.setBackgroundResource(R.drawable.icon_important);
			 * img3.setBackgroundResource(R.drawable.icon_half_important);
			 * img4.setBackgroundResource(R.drawable.icon_not_important);
			 * img5.setBackgroundResource(R.drawable.icon_not_important); } if(r
			 * >= 3.0f) { img1.setBackgroundResource(R.drawable.icon_important);
			 * img2.setBackgroundResource(R.drawable.icon_important);
			 * img3.setBackgroundResource(R.drawable.icon_important);
			 * img4.setBackgroundResource(R.drawable.icon_not_important);
			 * img5.setBackgroundResource(R.drawable.icon_not_important); } if(r
			 * >= 3.5f) { img1.setBackgroundResource(R.drawable.icon_important);
			 * img2.setBackgroundResource(R.drawable.icon_important);
			 * img3.setBackgroundResource(R.drawable.icon_important);
			 * img4.setBackgroundResource(R.drawable.icon_half_important);
			 * img5.setBackgroundResource(R.drawable.icon_not_important); } if(r
			 * >= 4.0f) { img1.setBackgroundResource(R.drawable.icon_important);
			 * img2.setBackgroundResource(R.drawable.icon_important);
			 * img3.setBackgroundResource(R.drawable.icon_important);
			 * img4.setBackgroundResource(R.drawable.icon_important);
			 * img5.setBackgroundResource(R.drawable.icon_not_important); } if(r
			 * >= 4.5f) { img1.setBackgroundResource(R.drawable.icon_important);
			 * img2.setBackgroundResource(R.drawable.icon_important);
			 * img3.setBackgroundResource(R.drawable.icon_important);
			 * img4.setBackgroundResource(R.drawable.icon_important);
			 ...
			 * Bitmap bmp = null;
			 * 
			 * if(!o.getAuxLocalization().isInternalLogoLoaded() &&
			 * o.getAuxLocalization().getAppLogo() != "") { String strUrl =
			 * o.getAuxLocalization().getAppLogo(); bmp =
			 * ImageRepository.Find(strUrl);
			 * 
			 * if(bmp == null) { try { URL url = new URL(strUrl); bmp =
			 * BitmapFactory
			 * .decodeStream(url.openConnection().getInputStream());
			 * ImageRepository.Store(strUrl, bmp); }catch (Exception e) { // no
			 * hacemos nada } } iv.setImageBitmap(bmp);
			 * o.getAuxLocalization().setInternalLogoLoaded(true);
			 * o.getAuxLocalization().setInternalLogo(bmp); }else { bmp =
			 * o.getAuxLocalization().getInternalLogo(); if(bmp != null) {
			 * iv.setImageBitmap(bmp); }else {
