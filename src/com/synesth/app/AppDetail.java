...
import com.synesth.model.Photo;
...
public class AppDetail extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CommentAdapter auxComAd = new CommentAdapter(SynesthActivity.GetAppContext(), R.layout.rowcom, this.mLoc.getAuxComments());
        ...
        SynesthActivity.getDbd().loadDrawable(this.mLoc.getAppLogo(), iv, SynesthActivity.getAppActivity().getResources().getDrawable(R.drawable.ic_refresh));
				...
				public void onClick(View v) {
					...
					if(anonLoc != null)
					{
						...
						if(anonLoc.getInternalApplicationInfo() != null)
						{
							...
							try
							{
								NetRequests.ActivityRequest(SynesthActivity.GetModel().currentLocation, "start", anonLoc.getId() + "", SynesthActivity.GetModel().currentUser.getId() + "");
								finish();
							}catch(Exception exc)
							{
						...
						{		
							...
							try
							{
								NetRequests.ActivityRequest(SynesthActivity.GetModel().currentLocation, "install", anonLoc.getId() + "", SynesthActivity.GetModel().currentUser.getId() + "");
							}catch(Exception exc)
							{
        ...
        */
        ...
        tvComments.setTypeface(SynesthActivity.getTypeFace());
				...
				if(anonLoc != null)
				{
					try
					{
						Thread th = new Thread(new Runnable() {							
							...
							public void run() {
								try {
									NetRequests.ActivityRequest(SynesthActivity.GetModel().currentLocation, "showcomments", anonLoc.getId() + "", SynesthActivity.GetModel().currentUser.getId() + "");
								} catch (Exception e) {
						...
						Thread th = new Thread(new Runnable() {							
							...
							public void run() {
								try {
									...
									NetRequests.ActivityRequest(SynesthActivity.GetModel().currentLocation, "favourite", anonLoc.getId() + "", SynesthActivity.GetModel().currentUser.getId() + "");
								} catch (Exception e) {
						...
						Thread th = new Thread(new Runnable() {							
							...
							public void run() {
								try {
									...
									NetRequests.ActivityRequest(SynesthActivity.GetModel().currentLocation, "pin", anonLoc.getId() + "", SynesthActivity.GetModel().currentUser.getId() + "");
								} catch (Exception e) {
							  ...
							  try
								{
									...
									SynesthActivity.getLocalizationAdapter().remove(anonLoc);
									SynesthActivity.getLocalizationAdapter().notifyDataSetChanged();
			        ...
			        if(anonLoc != null)
					{
						try
						{
							Thread th = new Thread(new Runnable() {							
								...
								public void run() {
									try {
										NetRequests.ActivityRequest(SynesthActivity.GetModel().currentLocation, "call", anonLoc.getId() + "", SynesthActivity.GetModel().currentUser.getId() + "");
									} catch (Exception e) {
										Log.i(getClass().getSimpleName(), "Thread Action Rate: " + e);
									}
								}
			        ...
			        if(anonLoc != null)
					{
						try
						{
							Thread th = new Thread(new Runnable() {							
								...
								public void run() {
									try {
										NetRequests.ActivityRequest(SynesthActivity.GetModel().currentLocation, "problem", anonLoc.getId() + "", SynesthActivity.GetModel().currentUser.getId() + "");
									} catch (Exception e) {
										Log.i(getClass().getSimpleName(), "Thread Action Rate: " + e);
									}
								}
