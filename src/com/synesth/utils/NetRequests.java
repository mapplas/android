...
public class NetRequests {
	...
	public static String RateRequest(String rate, String comment, String serverIpAddress, int serverPort, String serverPath, String id, String uid) throws Exception
	{
        ...
        nameValuePairs.add(new BasicNameValuePair("id", id));
        nameValuePairs.add(new BasicNameValuePair("uid", uid));
        nameValuePairs.add(new BasicNameValuePair("l", SynesthActivity.GetModel().currentLocation));
        nameValuePairs.add(new BasicNameValuePair("dl", SynesthActivity.GetModel().currentDescriptiveGeoLoc));
        post.setEntity(new UrlEncodedFormEntity(nameValuePairs));
